...
export class EmployeeInfoService {
  emp:EmpInfoModule;
  http:HttpClient;
    url : string = 'http://localhost:55709/api/EmployeeAPI';//copy your vscode url here upto employee api
  ...
  GetEmployeeByID(id:number):Observable<EmpInfoModule>{
    return this.http.get<EmpInfoModule>(this.url+"/"+"GetEmployeesByID"+"/"+id);
  }
